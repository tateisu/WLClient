...
fun Cursor.getByteArrayOrNull(keyIdx : Int) =
	if(isNull(keyIdx)) null else getBlob(keyIdx)

fun Cursor.getByteArrayOrNull(key : String) =
	getByteArrayOrNull(getColumnIndex(key))

fun Cursor.getByteArray(key : String) =
